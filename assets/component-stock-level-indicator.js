...
class StockLevelIndicator extends HTMLElement {
  constructor() {
    super();
    this.currentVariantId = this.dataset.armadaVariantId;
  }
  ...
  attachEvents() {
    document.addEventListener(`${window.eight.constants.events["ARMADA:VARIANT:CHANGE"]}`, this.handleVariantChange.bind(this));
  }
  ...
  handleVariantChange(e) {
    ...
    this.querySelector(`[data-armada-selector="stock-level-indicator--${this.currentVariantId}"]`)?.classList.add('hidden');
    this.querySelector(`[data-armada-selector="stock-level-indicator--${variantId}"]`)?.classList.remove('hidden');
    this.currentVariantId = variantId;
  }

  get productId() {
    return this.dataset.armadaProductId;
  }

  get scopeId() {
    return this.dataset.armadaScopeId;
  }

  detachEvents() {
    document.removeEventListener(`${window.eight.constants.events["ARMADA:VARIANT:CHANGE"]}`, this.handleVariantChange.bind(this));
  }
