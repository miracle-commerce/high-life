...
class AddressCardForm extends HTMLElement {
  ...
  setDefaultAddress(event) {
    ...
    fetch(
      ...
      return window.eight.sectionsEngine.sectionRenderingEngine.fetchSection(window.location.pathname, ['flotilla-customer-addresses'], [document.querySelector('customer-addresses')], ['customer-addresses']);
    }).catch((error) => {
