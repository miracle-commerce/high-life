...
class Sku extends HTMLElement {
  ...
  init() {
    this.attachEvents();
    window.eight.armada.elementRegistry.register({key: 'sku', assetPath: '/assets/component-sku.min.js'});
  }
  ...
  handleVariantChange(e) {
    ...
    const currentVariant = this.product.variants.find((variant) => variant.id === variantId);
    const sku = currentVariant ? currentVariant.sku : '';
...
window.customElements.define('armada-sku', Sku);
