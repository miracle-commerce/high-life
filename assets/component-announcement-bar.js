...
class AnnouncementBar extends HTMLElement {
  ...
  init() {
    window.eight.armada.elementRegistry.register({key: 'announcement-bar', assetPath: '/assets/component-announcement-bar.min.js'});
    this.setAnnouncementBarOffset();
  }

  setAnnouncementBarOffset() {
    document.documentElement.style.setProperty('--announcement-bar-bottom-position', `${this.getBoundingClientRect().bottom}px`);
  }
}
