...
class ProductRecommendations extends HTMLElement {
  ...
  init() {
    window.eight.armada.elementRegistry.register({key: 'product-recommendations', assetPath: '/assets/component-product-recommendations.min.js'});
      ...
      fetch(this.dataset.url)
        ...
        .then((text) => {
          ...
          if (recommendations && recommendations.innerHTML.trim().length) {
            window.eight.eventsEngine.namedEvents.animate(recommendations.querySelector('[data-armada-animation="grid-on-scroll"]'));
