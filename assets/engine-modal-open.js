...
class ArmadaModalOpen extends HTMLElement {
  ...
  init() {
    this.openButton = this.parentElement.querySelector('[data-armada-selector="modal-open"]') || this.querySelector('[data-armada-selector="modal-open"]') || this.firstElementChild;
    this.openButton.addEventListener('click', this.onButtonClick.bind(this));
    this.openButton.addEventListener('keyup', (e) => {
